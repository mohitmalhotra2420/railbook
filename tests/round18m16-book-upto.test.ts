...
vi.mock("../server/railway/router.js", async (importOriginal) => {
  ...
  return {
    ...mod,
    searchTrainsRouted: async () => ({ trains: [{ number: "12920", name: "MALWA EXPRESS", departure: "15:15", arrival: "13:35", durationMinutes: 1340, classes: [{ code: "3A" }, { code: "2A" }, { code: "1A" }], from: "LDH", to: "INDB" }], provider: "railcore" }),
